#!/usr/bin/env python3
"""Command-line script for converting Helsingin Sanomat HTML into plain text
"""
...
from ..htmltotext import extract_text_from_hs_html
...
def main():
    ...
    for input_spec in args.input:
        ...
        for input_file_name in glob.glob(input_files_glob):
            ...
            with open(input_file_name, encoding="utf-8") as inf:
                try:
                    content = extract_text_from_hs_html(inf)
