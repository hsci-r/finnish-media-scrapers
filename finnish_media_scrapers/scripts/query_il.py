#!/usr/bin/env python3
"""Command-line script for querying Iltalehti
"""
...
def parse_arguments():
    ...
    parser.add_argument(
        '-l', '--limit', help="number of articles to fetch per query (max==200)", default=200, type=int)
    parser.add_argument(
...
def main():
    ...
    with open(args.output, "w") as output_file:
        ...
        total_count = 0
        for response in query_il(args.query, args.from_date, args.to_date, args.limit):
