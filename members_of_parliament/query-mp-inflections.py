...
for name in names:
    ...
    if not os.path.isfile('../queries/il-inflections-' + name_replaced + ".csv"):
        os.system('fms-query-il -f 2020-01-01 -t 2020-12-31 -o ../queries/il-inflections-' +
                  name_replaced + '.csv' + '  -q ' + '"' + name + '"')

    if not os.path.isfile('../queries/is-inflections-' + name_replaced + ".csv"):
        os.system('fms-query-is -f 2020-01-01 -t 2020-12-31 -o ../queries/is-inflections-' +
                  name_replaced + '.csv' + '  -q ' + '"' + name + '"')

    if not os.path.isfile('../queries/yle-inflections-' + name_replaced + ".csv"):
        os.system('fms-query-yle -f 2020-01-01 -t 2020-12-31 -o ../queries/yle-inflections-' +
                  name_replaced + '.csv' + '  -q ' + '"' + name + '"')

    if not os.path.isfile('../queries/hs-inflections-' + name_replaced + ".csv"):
        os.system('fms-query-hs -f 2020-01-01 -t 2020-12-31 -o ../queries/hs-inflections-' +
                  name_replaced + '.csv' + '  -q ' + '"' + name + '"')
